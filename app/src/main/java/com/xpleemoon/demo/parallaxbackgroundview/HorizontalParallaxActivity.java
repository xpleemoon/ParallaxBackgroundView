...
public class HorizontalParallaxActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bg.setParallaxBackgroundResource(R.drawable.horizontal_parallax_bg);
//        BitmapFactory.Options options = new BitmapFactory.Options();
//        options.inJustDecodeBounds = true;
//        BitmapFactory.decodeResource(getResources(), R.drawable.horizontal_parallax_bg, options);
//        options.inJustDecodeBounds = false;
//        options.inSampleSize = 2;
//        Bitmap bitmap = BitmapFactory.decodeResource(getResources(), R.drawable.horizontal_parallax_bg, options);
